...
window.SEED_DATA = {
  ...
  lugares: [
    ...
    { id: "lg-tsurugaoka-hachimangu", nome: "Tsurugaoka Hachiman-gū", cidade: "kamakura", bairro: "centro de Kamakura", categoria: "templos", prioridade: "alta", status: "confirmar", motivo: "Principal santuário de Kamakura — é onde tradicionalmente acontecem as cerimônias de Yabusame.", notas: "Provável local do Yabusame do dia 16/09 — confirmar local exato do evento perto da data." },
