...
window.SEED_DATA = {
  ...
  reservas: [
    ...
    { id: "rs-hosp-tokyo1", nome: "The Royal Park Hotel Tokyo Haneda", tipo: "hospedagem", cidade: "toquio", data: "2026-09-05", horario: "check-in ~23:00 · check-out 06/09 até 11:00", endereco: "Conectado ao Terminal 3, saguão de partidas (3º andar) — entrada perto do balcão N", codigoReserva: "20260905-44031", status: "reservado", sensivel: true, fonte: "confirmação Royal Park Hotel (e-mail 06/08/2026)", notas: "Premium Comfort Single, plano Bed & Breakfast (café incluso). ¥29.600 (~R$1.015), pago no hotel. Taxa de hospedagem ¥200/pessoa cobrada à parte no check-in. Café da manhã 6h–10h no Tailwind (4º andar). Cancelamento grátis até 8 dias antes." },
  ...
  roteiro: [
    ...
    { id: "dia-0905", data: "2026-09-05", cidade: "toquio", titulo: "Chegada em Tóquio", manha: "Conexão em Dubai (8h40) · EK312 sai 07:40.", tarde: "Voo.", noite: "Chega em HND 22:20. Imigração + bagagem + transporte. Objetivo: só chegar e dormir.", deslocamentos: "Zero deslocamento — hotel conectado direto ao Terminal 3, entrada no saguão de partidas.", reservas: "The Royal Park Hotel Tokyo Haneda — confirmado (nº 20260905-44031)." },
